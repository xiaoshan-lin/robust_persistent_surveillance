...
class TrajectoryPoint(genpy.Message):
  _md5sum = "a3e9ef9667402c342c2c39b23c07961d"
...
float64 y
float64 z"""
  __slots__ = ['time_from_start','pose','velocity','acceleration','jerk','snap','heading','heading_rate','heading_acceleration']
  _slot_types = ['duration','geometry_msgs/Pose','geometry_msgs/Twist','geometry_msgs/Twist','geometry_msgs/Twist','geometry_msgs/Twist','float64','float64','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       time_from_start,pose,velocity,acceleration,jerk,snap,heading,heading_rate,heading_acceleration
...
def _get_struct_I():
    ...
    return _struct_I
_struct_2i34d = None
def _get_struct_2i34d():
    global _struct_2i34d
    if _struct_2i34d is None:
        _struct_2i34d = struct.Struct("<2i34d")
    return _struct_2i34d
