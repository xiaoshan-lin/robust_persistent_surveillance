...
class PS:  
    ...
    def maximum_partition(self):
        """
        This function computes the partition
        *args:
            None                      
        *return:
            - max_dist   maximum travel distance among the UAVs 
        ...
        [max_dist,solution,coo]=self.sub_partition(a,b,self.r)
        t_v=max_dist*self.footprint/self.v_max  
        age, max_dist, solution = self.calculate_age(a,b)
        self.a_best=a
        self.b_best=b
        self.solution_best=solution
        self.age=age
        return [a,b,solution,age]

    def plot_uav_path(self,coord_list,position,data,length_list):
        """
        This function plots the path for UAVs
        *args:
    ...
    def plot_path(self, coord_list,position,data,length_list, points):
        ...
        *return:
        ...
        line_list = self.plot_uav_path(coord_list,position,data,length_list)
    ...
    def calculate_age(self,a,b,data=None):
        ...
        age = sum(tv_array)+t_u

        return age, max_dist, solution                          
...
def test():
    ...
    #print(ps.calculate_age(ps.a_best,ps.b_best,data))
    #print(ps.a_best)
    #print(ps.b_best)
